...
def load_low_resource_split(config: ProjectConfig, split_name: str) -> pd.DataFrame:
    return pd.read_csv(config.low_resource_split_paths[split_name], low_memory=False)
